...
{
    public class GetForm16BCompletedListQuery
    : IRequest<IList<Form16BReqDto>>
    {
        public TdsPaymentFilter Filter { get; set; }
        public class GetForm16BCompletedListQueryHandler : IRequestHandler<GetForm16BCompletedListQuery, IList<Form16BReqDto>>
        {

            private readonly IApplicationDbContext _context;

            public GetForm16BCompletedListQueryHandler(IApplicationDbContext context)
            {
                _context = context;
            }

            public async Task<IList<Form16BReqDto>> Handle(GetForm16BCompletedListQuery request,
                CancellationToken cancellationToken)
            {
                ...
                var remittances = (from pay in _context.ClientPayment
                                   ...
                                   where (r != null && r.ChallanDate != null) &&
                                         cpt.RemittanceStatusID == (int)ERemittanceStatus.Form16BDownloaded &&
                                        // cp.OnlyTDS != true &&
                                   ...
                                   select new Form16BReqDto
                                   {
                                       ...
                                       AcknowledgementNo=r.ChallanAckNo,
