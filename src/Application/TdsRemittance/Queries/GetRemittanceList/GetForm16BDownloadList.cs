...
{
    public class GetForm16BDownloadList : IRequest<IList<Form16BReqDto>>
    {
        public TdsPaymentFilter Filter { get; set; }
        public class GetForm16BDownloadListHandler : IRequestHandler<GetForm16BDownloadList, IList<Form16BReqDto>>
        {

            private readonly IApplicationDbContext _context;

            public GetForm16BDownloadListHandler(IApplicationDbContext context)
            {
                _context = context;
            }

            public async Task<IList<Form16BReqDto>> Handle(GetForm16BDownloadList request,
                CancellationToken cancellationToken)
            {
                ...
                var remittances = (from pay in _context.ClientPayment
                                   ...
                                   where (r != null && r.ChallanDate != null) && request.Filter.RemittanceStatusID.HasValue ||
                                         cpt.RemittanceStatusID == (int)ERemittanceStatus.Form16BRequested 
                                         && cp.OnlyTDS != true &&
                                         r.F16BDateOfReq != null &&
                                         r.F16BRequestNo != null &&
                                         r.F16BCertificateNo==null &&
                                   ...
                                   select new Form16BReqDto
                                   {
                                       ...
                                       Form16BReqDatetime = r.Form16BReqDatetime,
